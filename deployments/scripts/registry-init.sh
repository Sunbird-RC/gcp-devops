...
gcloud sql instances describe functional-registry-pgsql --format=json  | jq -r ".ipAddresses[0].ipAddress" | xargs -I '{}' echo -n "postgres://registry:$db_pass@{}:5432/registry" | base64 -w 0 | xargs -I '{}' sed -i -E 's@DB_URL:.*@DB_URL: {}@' values.yaml
